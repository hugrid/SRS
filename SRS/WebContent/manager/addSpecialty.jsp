						...
						<tr>
							...
							<td width="43%" bgcolor="#FFFFFF">
								...
								<html:select property="enterYear">
									<html:option value="2015">2015届</html:option>
									<html:option value="2016">2016届</html:option>
									<html:option value="2017">2017届</html:option>
									<html:option value="2018">2018届</html:option>
									<html:option value="2019">2019届</html:option>
									<html:option value="2020">2020届</html:option>
